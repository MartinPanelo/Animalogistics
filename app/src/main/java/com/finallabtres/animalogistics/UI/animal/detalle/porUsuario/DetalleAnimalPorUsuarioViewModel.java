...
public class DetalleAnimalPorUsuarioViewModel extends AndroidViewModel {
    ...
    public DetalleAnimalPorUsuarioViewModel(@NonNull Application application) {
        super(application);
    ...
    public void editarAnimal(int IdAnimal, String nombre, String tipo, float edad, String tamanoCheckedRadioButton, boolean collarChecked, String genero, String estado, String comentarios, ImageView foto) {
        ...
        RequestBody Id = RequestBody.create(MediaType.parse("application/json"), String.valueOf(IdAnimal));
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (jsonObject.has("errors")) {
                                ...
                                ToastUtils.showToast(context, context.getString(R.string.problema_al_editar), R.color.toast_error,R.drawable.error);
                            }
